...
public class RpcHelper {
	...
	//set item with post method. request contains param, convert request(not java object) TO JSONObject
	...
	//read from request body, parse JSONOject item 
	public static Item parseFavoriteItem(JSONObject favoriteItem) throws JSONException {
		...
		//category is an array in request body
